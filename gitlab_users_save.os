...
Функция Main()
	...
	Для Каждого ЭлементСоответствия Из КоллекцияГрупп Цикл
		...
		Для Каждого Элемент Из Информация Цикл
			...
			// СтрокаТаблицы.Элемент = НоваяСтруктураСотрудника(Элемент.username, УровниДоступа[Элемент.access_level]);
...
Функция НоваяСтруктураСотрудника(username, access_level = "")
	...
	// Структура.username = username;
	// Структура.access_level = access_level;
	
	// Возврат Структура;
	
	Соответствие = Новый Соответствие;
	Соответствие[username] = access_level;
